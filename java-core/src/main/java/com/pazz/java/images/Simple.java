...
public class Simple {
    ...
    public static void main(String[] args) {
        URL url = Simple.class.getResource("");
//        String image = "D:\\repository\\pazzfj\\java\\java-test\\src\\main\\java\\com\\pazz\\java\\image\\身份证背2.jpg";
        AipOcr aipOcr = ImageUtils.getAipOcr();
        JSONObject jsonObject = aipOcr.idcard(url.getPath() + "身份证背2.jpg", "back", ImageUtils.OPTIONS);
