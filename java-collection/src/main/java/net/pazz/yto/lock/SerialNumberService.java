...
import net.pazz.utils.Argument;
import net.pazz.utils.DateUtils;
import net.pazz.yto.dao.SerialNumberRuleDao;
...
public class SerialNumberService implements ISerialNumberService {
    ...
    private SerialNumberEntry spliceSerialNumber(SerialNumberRuleEnum serialNumberEnum, SerialNumberRuleEntity serialNumberEntity,
        ...
        if (serialNumberEnum.isNeedTime() && serialNumberEnum.getTimeFormat().equals(DATE_TIME_MONTH)) {
            ...
            String currentDate = DateUtils.convert(serialNumberEntity.getCurrentTime(), DateUtils.DATE_MONTH_FORMAT);
            String nowDate = DateUtils.convert(Calendar.getInstance().getTime(), DateUtils.DATE_MONTH_FORMAT);
            ...
            String currentDate = DateUtils.convert(serialNumberEntity.getCurrentTime(), DateUtils.DATE_FORMAT);
