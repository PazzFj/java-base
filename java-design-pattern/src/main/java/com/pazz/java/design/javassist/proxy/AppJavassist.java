...
//        CtClass ct = pool.makeClass("com.pazz.java.design.javassist.proxy.Point");
        CtClass ct = pool.makeClass(Point.class.getName());
        ct.setInterfaces(new CtClass[]{pool.makeInterface("com.pazz.java.design.javassist.proxy.HelloInter")});
